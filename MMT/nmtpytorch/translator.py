...
class Translator(object):
    ...
    def translate(self, split):
        ...
        scores = (self.evaluator.score(hyps))
        print(scores)
        return self.filter(hyps), scores
